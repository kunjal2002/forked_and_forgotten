            ...
            for stat in contributions:
                if stat.author.login == contributor.login:
                    ...
                    contributor_data.append({
                            ...
                            "Status": is_active,
                            "First Activity": first_activity.replace(tzinfo=None),
                            "Last Activity": last_activity.replace(tzinfo=None),
...
# Example usage
repo_name = "JuliaLang/julia"  # Updated to target repository
...
# Save to Excel
output_file = "repo_contributor_data_JuliaLang_julia.xlsx"
